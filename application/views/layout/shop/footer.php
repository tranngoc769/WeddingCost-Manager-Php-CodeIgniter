	...
	<div class="modal fade" id="alert_modal">
		...
		<footer class="py-5 mt-5 bg-dark">
			<div class="container">
				<p class="m-0 text-center text-white">Copyright &copy; App Store 2017</p>
			</div>
			<!-- /.container -->
		</footer>
						...
						string += "<div class='col-lg-4 col-md-6 mb-4'>"
							+ "<div class='card h-100'>"
								+ "<a href='<?= base_url(); ?>index.php/Shop/product/"+data[i]['product_id']+"'>"
									...
									+ "<input type='number' name='quantity' class='form-control' value='1' hidden id='quantity_"+data[i]['product_id']+"' />"
