				...
				<div class="collapse navbar-collapse" id="navbarResponsive">
					<ul class="navbar-nav ml-auto">
						...
						<li class="nav-item">
							...
							<?php elseif ($this->session->userdata('usertype') == "user" || $this->session->userdata('usertype') == "dev") : ?>
								<?php if ( $this->session->userdata('usertype') == "dev") : ?>
									<li class="nav-item"><a class="nav-link"  href="<?php echo base_url()?>index.php/dev"><b>Developer</b></a></li>
								<?php endif; ?>
