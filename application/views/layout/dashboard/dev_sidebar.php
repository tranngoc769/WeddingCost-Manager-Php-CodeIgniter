	<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
		<a class="navbar-brand" href="<?php echo base_url().'index.php/dev'?>">Developer Dashboard</a>
				...
				<li class="nav-item" data-toggle="tooltip" data-placement="right" title="Products">
					...
					<ul class="sidenav-second-level collapse <?= $show_product; ?>" id="collapseMulti3">
						<li class="<?= $manage_product_active; ?>">
							<a href="<?= site_url('dev/view_product'); ?>">Manage</a>
						</li>
						<li class="<?= $add_product_active; ?>">
							<a href="<?= site_url('dev/add_product'); ?>">Add</a>
						</li>
					</ul>
				</li>
			</ul>
