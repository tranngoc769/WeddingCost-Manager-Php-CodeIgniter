                    ...
                    <div class="col-lg-3">
                        <div class="dashboard-nav bg-white rounded-lg shadow-xs">
                            ...
                            <ul class="dash-menu-ul">
                                ...
                                <li class="d-block rounded-lg"><a href="stat.html"><i class="ti-pie-chart font-sm"></i><span>Loại dịch vụ</span></a></li>
                                <li class="d-block rounded-lg "><a href="/index.php/admin/mucchi"><i class="ti-credit-card font-sm"></i><span>Mục chi</span></a></li>
