            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-8 navbar">
                         <a href="/" class="logo"><h1 class="fredoka-font ls-3 fw-700 text-current display1-size">Zipto</h1></a>
                                ...
                                <div class="row">
                                    <div class="col-lg-12 col-md-12">
                                        <div class="form-group mb-3">
                                            <input type="text" placeholder="Tên tài khoản" name="username" class="form-control h60 bg-color-none text-grey-700" value="">                        
                                        </div>        
                                    </div>
                                    <div class="col-lg-12 col-md-12">
                                        <div class="form-group mb-3">
                                            <input placeholder="Mật khẩu" type="text" name="password" class="form-control h60 bg-color-none text-grey-700" value="">                        
                                        </div>        
                                    </div>
                                    <div class="col-12">
